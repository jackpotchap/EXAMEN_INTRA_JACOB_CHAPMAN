...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_titre_age_min.setText(_translate("Dialog", "Âge Minimum"))
        self.label_titre_age_max.setText(_translate("Dialog", "Âge Maximum"))
        ...
        self.label_erreure_taille_age_min.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">* l\'âge doit ëtre supérieure a 0.</span></p></body></html>"))
        self.label_erreure_chiffreonly_num_age_min.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">* l\'âge doit être un nombre entier.</span></p></body></html>"))
        ...
        self.label_erreure_taille_num_age_max.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">* l\'âge doit etre supérieure a 0.</span></p></body></html>"))
        self.label_erreure_chiffreonly_num_age_max.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">* l\'âge doit etre un nombre entier.</span></p></body></html>"))
